...
{
  $("#s1").prepend(  
    '<video id="video-cover" src="./video/LoopFirstScreen_prores_Mp4_1080.mp4" width="100%" autoplay muted loop style="position: absolute; top: 0; left: 0;">HTML 5 is needed</video>'
  );

  $("#s14").prepend(
    '<video id="video-baby" src="./video/babyloop2-SD.mp4" width="100%" autoplay muted loop data-1180p="opacity: 0;" data-1190p="opacity: 1;" style="position: absolute; top: 0; left: 0;">HTML 5 is needed</video>'
  );
